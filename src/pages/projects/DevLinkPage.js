      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl sm:rounded-3xl p-6 sm:p-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4 sm:mb-6 text-center">{t('devLinkTitle')}</h2>
            <p className="text-white/80 text-base sm:text-lg leading-relaxed mb-6 text-center">
              {t('devLinkDescription')}
            </p>
            <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
              {['PHP', 'React', 'Tailwind', 'MySQL', 'JavaScript'].map((tech, index) => (
                <span
                  key={tech}
        ...
        >
          <motion.a
            href="https://devlink.satoshidc.cfolks.pl/"
            target="_blank"
          ...
          <motion.a
            href="https://github.com/Dawid-Czyzewski/DevLink"
            target="_blank"
            rel="noopener noreferrer"
